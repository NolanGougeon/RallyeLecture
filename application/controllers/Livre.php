...
class Livre extends CI_Controller {
    ...
    function index() {
        ...
        $data['nbLivre'] = $this->livreModel->get_livre_nombre();
        $config['base_url']=site_url().'/Livre/index/page';
        $page=$this->uri->segment(4,0);
        $config['total_rows']=$this->livreModel->get_livre_nombre();
        $config['per_page']=10;
    ...
    function recherche(){
        ...
        if ($this->form_validation->run()==TRUE) {
            ...
            $data['livres']=$this->livreModel->get_livre_recherche($recherche);
            $data['title']='Les Livres';
            $data['nbLivre'] = $this->livreModel->get_livre_nombre();
            $this->load->view('AppHeader',$data);
            $this->load->view('LivreIndex',$data);
